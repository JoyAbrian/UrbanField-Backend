...
INSERT INTO field_review (field_id, user_id, rating, review) VALUES
    (1, 2, 8, 'Tempatnya bersih dan nyaman, recommended!'),
    (1, 3, 7, 'Tempatnya bagus, tapi parkiran kurang luas'),
    (2, 2, 9, 'Tempatnya bersih dan nyaman, recommended!'),
    (2, 3, 10, 'Tempatnya bagus, tapi ruang ganti kurang luas'),
    (3, 2, 9, 'Tempatnya bersih dan nyaman, recommended!'),
    (3, 3, 8, 'Tempatnya bagus, tapi musholla kurang luas'),
    (4, 2, 7, 'Tempatnya bersih dan nyaman, recommended!'),
    (4, 3, 6, 'Tempatnya bagus, tapi kantin kurang luas'),
    (5, 2, 5, 'Tempatnya bersih dan nyaman, recommended!'),
    (5, 3, 8, 'Tempatnya bagus, tapi toilet kurang luas'),
    (6, 2, 9, 'Tempatnya bersih dan nyaman, recommended!'),
    (6, 3, 5, 'Tempatnya bagus, tapi parkiran kurang luas'),
    (7, 2, 5, 'Tempatnya bersih dan nyaman, recommended!'),
    (7, 3, 4, 'Tempatnya bagus, tapi ruang ganti kurang luas'),
    (8, 2, 8, 'Tempatnya bersih dan nyaman, recommended!'),
    (8, 3, 9, 'Tempatnya bagus, tapi musholla kurang luas'),
    (9, 2, 10, 'Tempatnya bersih dan nyaman, recommended!'),
    (9, 3, 7, 'Tempatnya bagus, tapi kantin kurang luas'),
    (10, 2, 4, 'Tempatnya bersih dan nyaman, recommended!'),
    (10, 3, 8, 'Tempatnya bagus, tapi toilet kurang luas'),
    (11, 2, 8, 'Tempatnya bersih dan nyaman, recommended!'),
    (11, 3, 9, 'Tempatnya bagus, tapi parkiran kurang luas'),
    (12, 2, 7, 'Tempatnya bersih dan nyaman, recommended!'),
    (12, 3, 7, 'Tempatnya bagus, tapi ruang ganti kurang luas');
